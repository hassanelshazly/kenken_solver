...
ArcConsistencySolver::ArcConsistencySolver(KenKenBoard board)
    : KenKenSolver(board) {}

void ArcConsistencySolver::solve() {
...
bool ArcConsistencySolver::ac_solve(const optional<Cell> &cell,
                                    vector<vector<set<uint8_t>>> domains) {
...
bool ArcConsistencySolver::ac3(Cell cell,
                               vector<vector<set<uint8_t>>> &domains) {
...
bool ArcConsistencySolver::remove_inconsistent_values(
    Cell xi, Cell xj, vector<vector<set<uint8_t>>> &domains) {
...
bool ArcConsistencySolver::can_satisfy(Cell xi, uint8_t val_i, Cell xj,
                                       uint8_t val_j) {
...
void ArcConsistencySolver::initialize_arcs() {
  if (arcs.size())
    return;
...
void ArcConsistencySolver::add_not_equal_arcs(Cell cell) {
...
void ArcConsistencySolver::add_arithmetic_arcs(Cell cell) {
